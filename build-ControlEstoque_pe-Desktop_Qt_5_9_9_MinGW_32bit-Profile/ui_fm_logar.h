...
public:
    ...
    void setupUi(QDialog *fm_logar)
    {
        ...
        fm_logar->resize(397, 104);
        widget = new QWidget(fm_logar);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(10, 10, 381, 85));
    ...
    {
        fm_logar->setWindowTitle(QApplication::translate("fm_logar", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("fm_logar", "Username", Q_NULLPTR));
        label_2->setText(QApplication::translate("fm_logar", "Senha", Q_NULLPTR));
        btn_logar->setText(QApplication::translate("fm_logar", "LOGAR", Q_NULLPTR));
        btn_cancelar->setText(QApplication::translate("fm_logar", "CANCELAR", Q_NULLPTR));
    } // retranslateUi
